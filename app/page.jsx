...
export default function Home() {
  return (
    <div className="text-violet-400 mt-32">
      <HeroSection />
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {
              howItWorksData.map((step, index) => (
                <div key={index} className="text-center">
                  <div className="size-16 bg-blue-100 rounded-full flex items-center justify-center mx-auto mb-6">{step.icon}</div>
                ...
                <Card key={index} className='p-6'>
                  <CardContent className='space-y-4 pt-4'>
                    <div className="flex items-center mb-4">
                      <Image src={user.image} alt={user.name} width={60} height={60} className="rounded-full"/>
      ...
      <section className="py-20 bg-blue-600">
        <div className="container mx-auto px-4 text-center">
          ...
          <Link href={'/dashboard'}>
            <Button className='bg-white hover:bg-blue-50 text-blue-600 animate-bounce cursor-pointer'>
              Start Free Trial
            </Button>
          </Link>
        </div>
